 ...
 * @param { String } userId
 */
export function getInviteCode(userId, matchId) {
    return fetchs(CONFIG.DOMAIN_PREFIX.hd + `/api/room/query`, { uid: userId, matchId: matchId }, 'GET');
}
